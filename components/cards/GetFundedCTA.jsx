  ...
  return (
    <div className="p-5 my-[2rem]">
      <div className="relative w-fit mx-auto p-[1px] rounded-[9px] overflow-hidden rotating-border-wrapper">
        ...
        {/* Actual Content */}
        <div className="bg-[#000713] w-full h-full">
          <div className="relative z-10 md:w-[596px] h-auto md:h-[60px] justify-evenly md:flex items-center mx-auto gap-[10px] px-5 py-10 text-[16px] text-[#7A7A7B] rounded-[9px] overflow-hidden get-funded-cta-card-bg">
